...
function initScene () {
  ...
  // ground
  var texture = THREE.ImageUtils.loadTexture('img/grasslight-big.jpg') // texture from three.js examples
  ...
  // main cube
  cube = new THREE.Mesh(new THREE.BoxGeometry(20, 20, 20), new THREE.MeshBasicMaterial({vertexColors: THREE.VertexColors}))

  cube.name = 'cube'

  // green child cube
  cube3 = new THREE.Mesh(new THREE.BoxGeometry(10, 10, 10), new THREE.MeshBasicMaterial({color: 0x00FF00}))
  ...
  // spinning cube
  cube2 = new THREE.Mesh(new THREE.BoxGeometry(2, 2, 2), new THREE.MeshBasicMaterial({color: 0xFF0000}))
